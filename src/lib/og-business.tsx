...
/** Tamanho padrão do card OG (1200×630). */
...
/**
 * Imagem OpenGraph do negócio (1200×630) — usada tanto na URL longa quanto na
 * curta /{handle}, pra o compartilhamento ficar bonito em qualquer endereço.
 */
export function businessOgImage(business: OgBusiness | null) {
