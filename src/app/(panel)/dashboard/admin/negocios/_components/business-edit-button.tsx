...
import { Pencil, X, Loader2, Link2, Sparkles, Power, PowerOff } from "lucide-react"
import { slugify } from "@/lib/utils"

const HOST = "acheinojardimbotanico.com.br"

export function BusinessEditButton({
  businessId, businessName, currentHandle, active, hasOwner,
}: {
  businessId: string; businessName: string; currentHandle: string | null; active: boolean; hasOwner: boolean
}) {
