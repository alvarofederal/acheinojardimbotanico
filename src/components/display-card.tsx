...
export function DisplayCard({ data }: { data: DisplayCardData }) {
  // separa o handle (último segmento) para destacar em dourado
  ...
  return (
    ...
    >
      ...
      <div
        style={{
          background: "#1E5C45",
          borderBottom: "0.5mm solid #D2B48C",
          padding: "6mm 4mm 5mm",
          textAlign: "center",
        }}
      >
        <svg width="9mm" height="11mm" viewBox="0 0 22 26" style={{ display: "block", margin: "0 auto 1.5mm" }}>
        ...
        <div style={{ fontSize: "5.2mm", fontWeight: 700, color: "#F4F0E8", lineHeight: 1 }}>
      ...
      >
        ...
        <div
          style={{
            ...
            borderRadius: "4mm",
            padding: "5mm",
            boxShadow: "0 1.1mm 4mm rgba(30,92,69,0.22)",
          }}
        >
          <QRCodeSVG
            value={data.url}
        ...
        <div style={{ textAlign: "center", width: "100%", fontFamily: "'Inter', Arial, sans-serif" }}>
          <div style={{ fontSize: "3.6mm", fontWeight: 700, color: "#1E5C45" }}>
            Aponte a câmera do seu celular
          </div>
          <div style={{ fontSize: "2.9mm", color: "#8C7459", marginTop: "0.5mm" }}>
          ...
          <div style={{ fontSize: "2mm", color: "#A39383", marginTop: "3mm", letterSpacing: "0.3mm" }}>
